...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [NeuronMesh](https://github.com/NeuronMesh) open-source ecosystem.
...
The `dashboard` application is the web frontend for NeuronMesh, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/NeuronMesh/dashboard
cd dashboard
npm install
```
